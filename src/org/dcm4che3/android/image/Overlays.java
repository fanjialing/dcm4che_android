...
public class Overlays {
   ...
   public static void extractFromPixeldata(Raster raster, int mask, 
		...
		case Raster.TYPE_SHORT:
			extractFromPixeldata(raster.getShortData(), rows, columns, columns, mask, ovlyData, off, length);
			break;

		default:
			extractFromPixeldata(raster.getByteData(), rows, columns, columns, mask, ovlyData, off, length);
			break;
		}
    ...
    public static void applyOverlay(int frameIndex, Raster raster,
